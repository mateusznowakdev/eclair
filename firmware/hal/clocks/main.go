...
// Configure changes the GCLK0 clock frequency to 8 MHz. This is the main clock
// and is used for CPU and most peripherals.
//
// This will make the USB peripheral unusable, so this function enables the
// GCLK5 clock at 48 MHz and assigns it to the USB peripheral.
func Configure() {
	configureCPUClock()
	configureUSBClock()
}
